...
const infoMessage = "¡Bingo! Están usando múltiples canales, pero eso solo hace el desafío más divertido. Si puedo capturar ambos fragmentos del mensaje, tendré la imagen completa en mis manos.";
...
function goToTimeoutPage() {
  ...
  window.location.href = 'video13.2.html';
}