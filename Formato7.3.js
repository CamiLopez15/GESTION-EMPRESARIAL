...
const infoMessage = "Pensé que con dividir el mensaje era suficiente, pero no proteger el fragmento sensible fue un error crítico. Ahora tienen suficiente información para reconstruir todo el mensaje. La seguridad parcial no es seguridad real.";
